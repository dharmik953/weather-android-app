            ...
            public void onResponse(JSONObject response) {
              // Toast.makeText(context, response.toString(), Toast.LENGTH_SHORT).show();
                ...
                for (int i = 0; i <consolidated_weather_list.length();i++) {
                    ...
                    one_day.setWeatrher_state_name(first_day_from_api.getString("weatrher_state_name"));
                    one_day.setWeatrher_state_abbr(first_day_from_api.getString("weatrher_state_abbr"));
...
//*********************************************************************************************************************************************************************************************************************************************************************************************************
    ...
    public void getCityForcatsByName(String ciryName, GetcutyFoecastByCallback getcutyFoecastByCallback){
            ...
            public void onResponce(String cityId) {
                getCityForecastById(cityId, new ForecastByIdResponse() {
                    ...
                    public void onResponce(List<WeatherReportModel> weatherReportModel) {
                        getcutyFoecastByCallback.onRespose(weatherReportModel);
                    }
                });
            }
        });
